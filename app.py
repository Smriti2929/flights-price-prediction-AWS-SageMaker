...
destination = st.selectbox(
    "Destination:",
    options=sorted(X_train.destination.unique())
)
...
additional_info = st.selectbox(
    ...
    options=sorted(X_train.additional_info.unique())
)
...
if st.button("Predict Price"):
    ...
    st.success(
        f"Predicted Flight Price: ₹ {prediction:,.0f}"
    )
